...
// Hero collage 3D tilt that follows the cursor. Disabled on touch devices
// (no hover) and when the visitor opted out of motion. The transform updates
// run through a single rAF loop rather than firing on every mousemove.
